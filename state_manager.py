...
def default_state() -> dict[str, Any]:
    return {
        ...
        "target_price_brl": None,
        "yellow_target_price_brl": None,
        "last_notified_price_brl": None,
        "last_rare_notified_price_brl": None,
        "last_good_notified_price_brl": None,
        "last_green_notified_price_brl": None,
        "last_yellow_notified_price_brl": None,
        "last_cheapest": None,
        "last_cheapest_fingerprint": None,
        "run_counter": 0,
        "route_baselines": {},
        "route_baseline_medians": {},
        "seen_md_guids": [],
        "serpapi_month_key": "",
        "serpapi_calls_month": 0,
        "serpapi_day_key": "",
        "serpapi_calls_today": 0,
        "serpapi_deals_day_key": "",
        "serpapi_deals_today": 0,
